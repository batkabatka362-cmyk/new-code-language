...
PrimitiveType   ::= "u8" | "u16" | "u32" | "u64"
                  ...
                  | "f4" | "f8" | "f16" | "bf16" | "f32" | "f64"
                  | "bool" | "wave_t" | "ext_addr_t" | "spk_stamp"
                  | "tile4x4_f32" | "tile4x4_i32" | "tile16x16_i2"
SpatialType     ::= SpatialAttr? PrimitiveType
SpatialAttr     ::= "@sram" ("(" "bank" "=" IntLiteral ")")?
                  | "@hbm" ("(" "channel" "=" IntLiteral ")")?
                  | "@noc" "(" IntLiteral "," IntLiteral "," IntLiteral "," IntLiteral ")"
